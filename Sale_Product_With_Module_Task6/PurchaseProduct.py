...
class PurchaseProduct(TotalTax):
    ...
    def purchase_product(self,purchaseProductDate,purchaseProductQuantity,purchaseProductVendorName,purchseProductBasicPrice,purchaseProductTotalPrice):
        ...
        self.purchase_product_detail[len(self.purchase_product_detail)+1] = {'purchaseordernumber':purchaseOrderNumber,'productdate':purchaseProductDate,'productqty':purchaseProductQuantity,'purchasevendorname':purchaseProductVendorName,'purchasebasicprice':purchseProductBasicPrice,'purchasetotalprice':purchaseProductTotalPrice,'purchasetotaltax':purhaseProductTotalTax}  
