...
class SaleProduct(TotalTax):
    ...
    def sale_product(self,saleProductDate,saleQuantity,saleVendorName,saleBasicPrice,saleTotalPrice,Type):
        ...
        self.sale_product_detail[len(self.sale_product_detail)+1] = {'saleordernumber':saleOrderNumber,'saledate':saleProductDate,'saleqty':saleQuantity,'salevendorname':saleVendorName,'salebasicprice':saleBasicPrice,'saletotalprice':saleTotalPrice,'totalsaletax':saleTotalTax}    
